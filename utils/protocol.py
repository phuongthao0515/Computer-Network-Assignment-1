...
def create_request(command, payload, separater = ""):
    """
    ...
    #         payload = [payload]
    #     return f"{command.value}\r\n{json.dumps(payload)}{Separater}".encode("utf-8")
    elif command in [Command.HOST, Command.MESSAGE,
...
def create_response(status, payload, separater = ""):
    """
